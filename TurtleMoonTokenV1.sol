...
abstract contract Tokenomics is Manageable {
    ...
    string internal constant NAME = "TurtleMoonToken";
    string internal constant SYMBOL = "TMT";
    ...
    address internal charityAddress = 0x9E6F67AfC6D04BEF244627550e1EB5F2AFE2E449;
    address internal marketingAddress = 0x9E6F67AfC6D04BEF244627550e1EB5F2AFE2E449;
    ...
    function changeFees(uint256 _RfiFee, uint256 _burnFee, uint256 _liquidityFee, uint256 _charityFee, uint256 _marketingFee) public onlyManager {
...
// Part: TurtleMoonToken

//////////////////////////////////////////////////////////////////////////

abstract contract TurtleMoonToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract TurtleMoonTokenV1 is TurtleMoonToken{

    constructor() TurtleMoonToken(Env.Testnet){
